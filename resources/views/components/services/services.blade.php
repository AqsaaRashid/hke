...
<section class="services-section">
   ...
   <div class="services-grid">
    ...
    <div class="service-cards">
        ...
        <p>We transform existing spaces into modern, functional, and stylish environments.
 ...
 <img src="/images/b3.png"class="servicess-icon">        <h3>Project Management</h3>
        <p>Our experts handle every stage — from planning and budgeting to execution and
 ...
 <img src="/images/b4.png"class="servicess-icon">        <h3>Infrastructure Development</h3>
        <p>We support large-scale infrastructure needs including roads, drainage systems,
 ...
 <img src="/images/bb5.png"class="servicess-icon">        <h3>Architectural Planning</h3>
        <p>Our architects provide creative, efficient, and practical designs tailored to client needs,
 ...
 <img src="/images/bb6.png"class="servicess-icon">        <h3>Material Supply</h3>
        <p>We provide reliable construction materials and manage advanced machinery to ensure
